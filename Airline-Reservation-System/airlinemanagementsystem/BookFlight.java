...
public class BookFlight extends JFrame implements ActionListener {
    ...
    private void setupUI() {
        ...
        // Flights table setup
        String[] columnNames = { "Flight ID", "Flight Name", "Flight Number", "Departure", "Arrival", "Travel Date", "Available Seats", "Price", "Journey Time", "Arrival Date", "Departure Date" }; // Updated column names
